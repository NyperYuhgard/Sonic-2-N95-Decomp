...
public class cCanvas extends crlCanvas {
   ...
   public void rotatePaint(Graphics var1) {
      var1.setColor(7375521);
      var1.setClip(0, 0, 1000, 500);
      var1.fillRect(0, 0, newWidth, newHeight);
      var1.setColor(255, 255, 255);
      var1.drawString(screenRotatedString[m_Option[0]], newWidth / 2, newHeight / 2, 17);
   }
   ...
   public final void run() {
      ...
      if ((var1 = loadData("settings")) == null) {
         ...
         System.out.println("loading options; data.length=" + var1.length);
      }
   ...
   public static void initViewPort() {
      viewPortHeight = viewPortWidth = crlCanvas.getGameWidth();
   ...
   public static void setSoftLabel(int var0, String var1) {
      if (var0 == 256) {
         softkeyLabels[0] = var1;
      } else {
         if (var0 == 512) {
            softkeyLabels[1] = var1;
         }
   ...
   private void a() {
      ...
      if ((var3 = loadData("rankings")) == null) {
         (m_Ranking = new int[5][2])[0][0] = 10000;
         m_Ranking[0][1] = 0;
         m_Ranking[1][0] = 8000;
         m_Ranking[1][1] = 1;
         m_Ranking[2][0] = 6000;
         ...
         for(int var1 = 0; var1 < m_Ranking.length; ++var1) {
            int[] var2 = crlUtil.loadIntArray(var3, 8, var1 << 3);
            m_Ranking[var1] = var2;
         }
   ...
   public static byte[] loadData(String var0) {
      ...
      for(int var3 = 1; var3 >= 0 && var2 == null; --var3) {
         try {
            STH2P1.getProperty("MIDlet-Vendor");
            Object var4 = null;
            var2 = (var1 = RecordStore.openRecordStore(var0, false)).getRecord(1);
            ...
            } catch (RecordStoreNotOpenException var16) {
   ...
   public static void saveData(String var0, byte[] var1) {
      String var2 = STH2P1.getProperty("MIDlet-Name");
      ...
      for(int var3 = 1; var3 >= 0; --var3) {
         ...
         try {
            if (var4.equals(var2)) {
               if (saveDataExists(var0)) {
                  RecordStore.deleteRecordStore(var0);
               }

               var5 = RecordStore.openRecordStore(var0, true, 1, true);
            } else {
               var5 = RecordStore.openRecordStore(var0, STH2P1.getProperty("MIDlet-Vendor"), var4);
            }

            try {
               var5.setRecord(1, var1, 0, var1.length);
            ...
            } catch (RecordStoreNotOpenException var18) {
   ...
   public static boolean saveDataExists(String var0) {
      try {
         ...
         return false;
      } catch (RecordStoreFullException var2) {
      } catch (RecordStoreException var3) {
   ...
   public static void initAudio() {
      (am = new Sonic2AudioManager()).open((iAudioLoader)null, 13);
   }
}
